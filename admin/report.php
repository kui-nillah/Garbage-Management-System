<?php 
    ...
    if(isset($_POST['send'])) { 
        ...
        $endDate=$_POST['endDate'];
            $message= Librarie::getReport($startDate, $endDate);
  ...
  color: #818181;
    ...
    <body>
        ...
        <section class="dashboard">
            ...
            <form name="report" action="<?php echo $s = $_SERVER['SCRIPT_NAME']; ?>"  method="POST"  class="report">
                        <div>
                        <label>From Date:</label>
                        <input type="date" name="startDate" required class="rep-in">   
                        </div>
                        <div>
                        <label>From Date:</label>
                        <input type="date" name="endDate" required class="rep-in">   
                        </div>
                        <div>
                        <button class="rep-btn" value="submit" name="send">Generate</button>
                        </div> 
                    </form>
