<?php 
    ...
    if (isset($_POST['register'])) {
        ...
        $complain_id = $_POST['complain_id'];
         ...
         if($driverID === "" || $complain_id === ""){

         }else{
            $message = "";
              if(Librarie::setDriverAssign($driverID , $complain_id)){
                 if(Librarie::setUpDateUserComplainStatus($complain_id)){
                        ...
                        <div class="fields">
                            ...
                            <p><?php echo $message; ?></p>
                                ...
                                <select name="driverID">
                                    <option value=""></option>
                                    <?php Librarie::getDriverList('003'); ?>
                                </select>
                                <input type="text" name="complain_id" hidden value="<?php echo $complain_id ; ?>">
                                <button value="submit" name="register">Assign Driver</button>
                            </div>
